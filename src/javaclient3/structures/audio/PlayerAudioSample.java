 ...
 *
 * $Id: PlayerAudioSample.java 148 2011-08-22 14:37:59Z corot $
 *
 */
 ...
 * Describes an audio sample. If the index is set to -1, the next available
 * slot is used and the index is returned in the response.
