 ...
 *
 * $Id: AudioInterface.java 149 2011-08-22 14:39:16Z corot $
 *
 */
package javaclient3;
 ...
 * The interface provides four sets of functionality:
 * - raw waveform playback and recording
 * - audio sample playback and loading
...
public class AudioInterface extends PlayerDevice {
    ...
    /**
     * The audio interface reads four types of data:
     * - recorded digitized waveform
     * - recorded sequences of tones
     * - mixer channels sound level
     * - state of target audio device
     */
